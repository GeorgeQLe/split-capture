if(SPLIT_CAPTURE_ENABLE_CUSTOM_UPDATER)
  if(NOT SPLIT_CAPTURE_UPDATE_FEED_URL OR NOT SPLIT_CAPTURE_UPDATE_PUBLIC_KEY)
    message(
      FATAL_ERROR
        "SPLIT_CAPTURE_ENABLE_CUSTOM_UPDATER requires SPLIT_CAPTURE_UPDATE_FEED_URL and SPLIT_CAPTURE_UPDATE_PUBLIC_KEY"
    )
  endif()

  set(SPARKLE_APPCAST_URL "${SPLIT_CAPTURE_UPDATE_FEED_URL}")
  set(SPARKLE_PUBLIC_KEY "${SPLIT_CAPTURE_UPDATE_PUBLIC_KEY}")
