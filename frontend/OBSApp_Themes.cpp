...
void OBSApp::FindThemes()
{
	...
	{
		const std::string themeDir = App()->userConfigLocation.u8string() + "/split-capture/themes";
...
bool OBSApp::SetTheme(const QString &name)
{
	...
	string filename("split-capture/themes/");
...
bool OBSApp::InitTheme()
{
	...
	char userDir[512];
	if (GetAppConfigPath(userDir, sizeof(userDir), "split-capture/themes")) {
