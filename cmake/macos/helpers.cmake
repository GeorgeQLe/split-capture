  ...
  if(target_type STREQUAL EXECUTABLE)
    if(target STREQUAL obs-studio)
      ...
      set_target_xcode_properties(
        ${target}
        PROPERTIES PRODUCT_BUNDLE_IDENTIFIER io.github.georgeqle.splitcapture
                   PRODUCT_NAME "Split Capture"
                   ...
                   INFOPLIST_KEY_CFBundleDisplayName "Split Capture"
                   INFOPLIST_KEY_NSHumanReadableCopyright
                     "(c) 2012-${CURRENT_YEAR} OBS contributors, Split Capture by GeorgeQLe"
                   INFOPLIST_KEY_NSCameraUsageDescription
                     "Split Capture needs camera access to record a separate camera file."
                   INFOPLIST_KEY_NSMicrophoneUsageDescription
                     "Split Capture needs microphone access to record audio."
                   INFOPLIST_KEY_NSAppleEventsUsageDescription
                     "Split Capture needs background event access to enable hotkeys while not in focus."
      )
